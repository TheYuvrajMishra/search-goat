# Candidate Job Hunt & Outreach Context
Use this file to describe your professional background, resume details, target roles, technical skills, and the networking/interview goals you want to pitch to companies.
...
- **Frameworks & Libraries**: React, Next.js, Express.js, Node.js, TailwindCSS, Framer Motion
...
- **Target Person**: Hiring Manager, Engineering Team Lead, or Founder
- **Target Companies**: Early-stage foreign (non-Indian) startups, preferably YC-backed
- **The Angle**: Self-taught, shipped real products in production — not just side projects. Strong full-stack + UI/UX combo. Built and co-founded Foontro independently. Proven ability to move fast at early-stage companies.
